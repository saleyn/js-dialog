(()=>{function M(){let T=this,y="dlg-window";class ${constructor(e,t,d,a,u,h,n={}){let l=localStorage.getItem(i.Defaults.persistKey);(l===null||l==="null")&&(l=void 0);let g=n.theme||(l!==void 0?l:document.body.classList.contains("dark-mode")?"dark":document.body.classList.contains("light-mode")?"light":window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"),s=g==="dark",f=`dlg-${g}-mode`;(l===void 0||n.theme!=null&&l!=n.theme)&&localStorage.setItem(i.Defaults.persistKey,g);let c=i.Defaults.themes[g];if(!c)throw new Error(`Invalid dialog theme found for '${n.theme}': ${g}`);n=i.deepClone(i.Defaults,n),e=(e||y).replace("#","");let r=e,m=0;for(;i.openDialogs.ids.find(v=>v.id===r)!==void 0;)r=`${e}-${++m}`;this.id=r,this.index=m,n.persistent=n.persistent?`${this.id}-${t.toLowerCase()}`:void 0;let b=document.getElementById(e);this.element=this.index==0&&b!==void 0?b:document.getElementById(this.id),this.element||(this.index==0&&b?this.element=b:(this.element=document.createElement("div"),this.element.setAttribute("id",this.id),b?b.appendChild(this.element):document.body.appendChild(this.element),this.addedToParent=!0,b||(b=this.element))),this.index==0&&this.element.classList.add(y),this.element.innerHTML=`
        <div id="${this.id}-box"  class="dlg-box">
        <div id="${this.id}-head" class="dlg-head">
        <div id="${this.id}-top"  class="dlg-top"><div class="dlg-title">${d}</div>
...
`),k=document.createElement("style");k.type="text/css",k.innerHTML=B,document.getElementsByTagName("head")[0].appendChild(k)}n={persistent:n.persistent},i.dragElement(x,I,Object.assign(n,{top:D,left:E})),this.element.style.display="block",x.style.display="block",i.openDialogs.ids.push({id:this.id,ele:e,instance:this}),this.promptType=t,this.oncloseArgs=h}close=(...e)=>{if(this.closePending||(typeof this.oncloseArgs=="function"?this.oncloseArgs(...e):window[this.oncloseArgs]&&(window[this.oncloseArgs](...e),this.waitForClose=!0)),this.closePending=!0,i.openDialogs.ids.length>0&&i.openDialogs.ids[i.openDialogs.ids.length-1].id===this.id){this.element.style.display="none",this.element.innerHTML="",document.onkeydown=this.oldKeyDown;let t=this.id,d=i.openDialogs.ids.pop(),a=d.instance;a.addedToParent&&a.element.parentElement.removeChild(a.element),delete d.instance,a=i.openDialogs.ids.length?i.openDialogs.ids[i.openDialogs.ids.length-1].instance:void 0,a&&a.close()}};toggleTheme=()=>{let e=localStorage.getItem(i.Defaults.persistKey),t=e=="dark"?"light":"dark";confirm(`Are you sure you want to toggle dialog theme from '${e}' to '${t}'?`)&&localStorage.setItem(i.Defaults.persistKey,t)}}return{Defaults:{persistent:!1,persistKey:"dlg-theme-mode",theme:"dark",className:y,css:{window:`.${y} {
          ...
          }`},default:{colors:{"dlg-win-bg-color":"rgba(10,10,10,0.6)","dlg-border-color":"none","dlg-footer-fg-color":"#CCC","dlg-footer-bg-color":"#444","dlg-btn-fg-color":"black"}},themes:{dark:{colors:{"dlg-title-fg-color":"#c6c6cf","dlg-title-bg-color":"#2e2f3a","dlg-bg-color":"#2e2f3a","dlg-body-fg-color":"#9797a2","dlg-body-bg-color":"#2e2f3a","dlg-input-fg-color":"#e4e6ea","dlg-input-bg-color":"#444452","dlg-input-outline":"none","dlg-input-outline-focus":"1px solid #649ad5","dlg-btn-border":"1px solid #649ad5","dlg-btn-fg-color":"#649ad5","dlg-btn-bg-color":"#444452","dlg-btn-hover-fg-color":"white","dlg-btn-hover-bg-color":"#88c1ff","dlg-btn-def-fg-color":"#2e2f3a","dlg-btn-def-bg-color":"#649ad5","dlg-btn-def-hover-fg-color":"white","dlg-btn-def-hover-bg-color":"#88c1ff"}},light:{colors:{"dlg-title-fg-color":"#636363","dlg-title-bg-color":"#f2f3f7","dlg-bg-color":"#f2f3f7","dlg-body-fg-color":"#636363","dlg-body-bg-color":"#f2f3f7","dlg-input-fg-color":"#636363","dlg-input-bg-color":"white","dlg-input-outline":"1px solid #d7d7d7","dlg-input-outline-focus":"1px solid #649ad5","dlg-btn-border":"1px solid #649ad5","dlg-btn-fg-color":"#649ad5","dlg-btn-bg-color":"white","dlg-btn-active-bg-color":"blue","dlg-btn-hover-fg-color":"white","dlg-btn-hover-bg-color":"#88c1ff","dlg-btn-def-fg-color":"#EEE","dlg-btn-def-bg-color":"#649ad5","dlg-btn-hover-border":"1px solid blue","dlg-btn-def-hover-fg-color":"white","dlg-btn-def-hover-bg-color":"#88c1ff"}}}},openDialogs:{ids:[]},close:(o,...e)=>{if(i.openDialogs.ids.length==0)return;let t=o!=null?i.openDialogs.ids.find(d=>d.id===o):i.openDialogs.ids[i.openDialogs.ids.length-1];if(t!==void 0)t.instance.close(...e);else throw new Error(`Cannot find Dialog with id=${o}`)},deepClone:(o,e=void 0,t=()=>!0)=>{let d={};function a(u,h,n){for(let[l,g]of Object.entries(h)){if(!t(n,l))continue;if(Array.isArray(g)){u[l]=g.slice();continue}else if(g===null||typeof g!="object"){u[l]=g;continue}u[l]===void 0&&(u[l]=new g.__proto__.constructor);let s=[...n,l];a(u[l],g,s)}}return a(d,o,[]),e!==void 0&&a(d,e,[]),d},dragElement:(o,e,t={})=>{let d=o,a=e;if(typeof o=="string"&&(o=document.getElementById(o)),typeof e=="string"&&(e=document.getElementById(e)),o==null||typeof o!="object")throw`Cannot find element: ${o}`;if(e==null||typeof o!="object")throw`Cannot find header:  ${e}`;let u=r=>{r=r||window.event,r.preventDefault(),f=r.clientX,c=r.clientY,document.onmouseup=l,document.onmousemove=n},h=(r,m)=>{let b=o.offsetHeight/2,x=o.offsetWidth/2;o.style.top=Math.max(b,Math.min(r,window.innerHeight-b))+"px",o.style.left=Math.max(x,Math.min(m,window.innerWidth-x))+"px"},n=r=>{r=r||window.event,r.preventDefault(),g=f-r.clientX,s=c-r.clientY,f=r.clientX,c=r.clientY,h(o.offsetTop-s,o.offsetLeft-g)},l=()=>{document.onmouseup=null,document.onmousemove=null,t.persistent&&localStorage.setItem(t.persistent,JSON.stringify({top:o.offsetTop,left:o.offsetLeft}))},g=0,s=0,f=0,c=0;e.onmousedown=u,(t.top||t.left)&&h(t.top,t.left)},alert:(o,e,t={})=>new $(t.element,"Alert",o,e,`<button class="default" onclick="Dialog.close(${t.element})">OK</button>`,void 0,t),confirm:(o,e,t,d={})=>{let a=d.buttons||[{title:"Ok"},{title:"Cancel"}],u=d.btnOk||0,h=d.defbtn||0,n=a.map((l,g)=>{let s=Object.keys(l).filter(f=>f!="value");return`<button${h==g?' class="default"':""} onclick="Dialog.close(${d.element}, ${g==u})"`+s.map(f=>` ${f}=${l[f]}`).join("")+`>${l.value?l.value:l.title}</button>
`}).join("");return new $(d.element,"Confirm",o,e,n,t,d)},prompt:(o,e,t,d={})=>{let a=d.inputs||[{label:"Enter a value",id:"value"}],u=d.buttons||[{title:"Ok"},{title:"Cancel"}],h=d.defbtn||0,n=d.element;e+=a.map((s,f)=>`<label for="${s.id}" text="${s.label}"/><input id="${s.id}"`+Object.keys(s).filter(c=>c!="label").map(c=>` ${c}="${s[c]}"`).join("")+">").join("");let l=u.map((s,f)=>`<button ${f==h?" class='default'":""}`+Object.keys(s).filter(c=>c!="value").map(c=>` ${c}="${s[c]}"`).join("")+` onclick="Dialog.close(${n}, ${f})">${s.value?s.value:s.title}</button>
`).join(""),g=s=>{let f=a.map(r=>{let m=document.getElementById(r.id),x=m&&m!=null&&m.value?m.value:void 0;return{id:r.id,value:x}}),c={ok:s==h,button:s,values:f};return typeof t=="function"?t(c):t!==void 0&&window[t]?window[t](c):c};return new $(n,"Prompt",o,e,l,g,d)}}}var i=M(),H=i;window.Dialog=i;})();
